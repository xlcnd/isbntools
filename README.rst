...
.. image:: https://coveralls.io/repos/github/xlcnd/isbntools/badge.svg?branch=v4.3.26
    :target: https://coveralls.io/github/xlcnd/isbntools?branch=v4.3.26
    :alt: Coverage Status
...
.. image:: https://travis-ci.org/xlcnd/isbntools.svg?branch=v4.3.26
    :target: https://travis-ci.org/xlcnd/isbntools
    :alt: Built Status

.. image:: https://ci.appveyor.com/api/projects/status/github/xlcnd/isbntools?branch=v4.3.26&svg=true
...
.. code-block:: console
    ...
    $ isbn_repl
        ...
        Welcome to the isbntools 4.3.26 REPL.
