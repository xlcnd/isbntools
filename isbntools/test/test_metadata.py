...
def test_query():
    ...
    assert_raises(Exception, query, '9780321534965', 'goog')
    assert_equals(len(repr(query('9781849692342', 'goob'))) > 200, True)
    ...
    assert_equals(len(repr(query('9781118241257'))) > 150, True)
...
def test_ext_meta():
    # test meta from core
    assert_equals(len(repr(meta('9781849692342', 'goob'))) > 200, True)
