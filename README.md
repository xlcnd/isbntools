...
[![Coverage Status](https://coveralls.io/repos/xlcnd/isbntools/badge.png?branch=v4.2.4)](https://coveralls.io/r/xlcnd/isbntools?branch=v4.2.4)
[![Build Status](https://travis-ci.org/xlcnd/isbntools.svg?branch=v4.2.4)](https://travis-ci.org/xlcnd/isbntools)
[![Build status](https://ci.appveyor.com/api/projects/status/github/xlcnd/isbntools?branch=v4.2.4&svg=true)](https://ci.appveyor.com/project/xlcnd/isbntools)
...
$ isbn_repl
    ...
    Welcome to the isbntools 4.2.4 REPL.
...
```bash
$ pip install isbntools-4.2.4.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-4.2.4.tar.gz) the file!
