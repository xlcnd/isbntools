...
[![Coverage Status](https://coveralls.io/repos/xlcnd/isbntools/badge.png?branch=v3.3.2)](https://coveralls.io/r/xlcnd/isbntools?branch=v3.3.2)
...
[![Build Status](https://travis-ci.org/xlcnd/isbntools.png?branch=v3.3.2)](https://travis-ci.org/xlcnd/isbntools.png?branch=v3.3.2)
...
```bash
$ pip install isbntools-3.3.2.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-3.3.2.tar.gz) the file!
