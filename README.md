...
[![Coverage Status](https://coveralls.io/repos/github/xlcnd/isbntools/badge.svg?branch=v4.3.17)](https://coveralls.io/github/xlcnd/isbntools?branch=v4.3.17)
[![Graph](https://img.shields.io/badge/Sourcegraph-Status-blue.svg)](https://sourcegraph.com/github.com/xlcnd/isbntools)
[![Build Status](https://travis-ci.org/xlcnd/isbntools.svg?branch=v4.3.17)](https://travis-ci.org/xlcnd/isbntools)
[![Build status](https://ci.appveyor.com/api/projects/status/github/xlcnd/isbntools?branch=v4.3.17&svg=true)](https://ci.appveyor.com/project/xlcnd/isbntools)
...
The output can be formatted as `bibtex`, `csl` (CSL-JSON), `msword`,  `endnote`, `refworks`, `opf`, or
...
$ isbn_repl
    ...
    Welcome to the isbntools 4.3.17 REPL.
...
```bash
$ pip install isbntools-4.3.17.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-4.3.17.tar.gz) the file!
