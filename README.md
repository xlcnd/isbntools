...
[![Coverage Status](https://coveralls.io/repos/xlcnd/isbntools/badge.png?branch=v4.3.6)](https://coveralls.io/r/xlcnd/isbntools?branch=v4.3.6)
[![Build Status](https://travis-ci.org/xlcnd/isbntools.svg?branch=v4.3.6)](https://travis-ci.org/xlcnd/isbntools)
[![Build status](https://ci.appveyor.com/api/projects/status/github/xlcnd/isbntools?branch=v4.3.6&svg=true)](https://ci.appveyor.com/project/xlcnd/isbntools)
...
$ isbn_repl
    ...
    Welcome to the isbntools 4.3.6 REPL.
...
```bash
$ pip install isbntools-4.3.6.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-4.3.6.tar.gz) the file!
