...
[![Coverage Status](https://coveralls.io/repos/github/xlcnd/isbntools/badge.svg?branch=v4.3.11)](https://coveralls.io/github/xlcnd/isbntools?branch=v4.3.11)
[![Build Status](https://travis-ci.org/xlcnd/isbntools.svg?branch=v4.3.11)](https://travis-ci.org/xlcnd/isbntools)
[![Build status](https://ci.appveyor.com/api/projects/status/github/xlcnd/isbntools?branch=v4.3.11&svg=true)](https://ci.appveyor.com/project/xlcnd/isbntools)
...
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-4.3.11.tar.gz) the file!
