...
[![Build Status](https://travis-ci.org/xlcnd/isbntools.png?branch=v2.3.7)](https://travis-ci.org/xlcnd/isbntools)
...
```bash
    ...
    $ pip install isbntools-2.3.7.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-2.3.7.tar.gz) the file!
...
[standalone version](https://sourceforge.net/projects/isbntools/files/isbntools-2.3.7-win.zip/download)
...
[![Download format](https://pypip.in/format/isbntools/badge.png)](https://pypi.python.org/pypi/isbntools/)
[![License](https://pypip.in/license/isbntools/badge.png)](https://pypi.python.org/pypi/isbntools/)
[![Build Status](https://travis-ci.org/xlcnd/isbntools.png?branch=v2.3.8)](https://travis-ci.org/xlcnd/isbntools)
...
```bash
    ...
    $ pip install isbntools-2.3.8.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-2.3.8.tar.gz) the file!
