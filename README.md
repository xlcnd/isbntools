...
[![Build Status](https://travis-ci.org/xlcnd/isbntools.png?branch=v2.2.2)](https://travis-ci.org/xlcnd/isbntools)
...
```bash
    ...
    $ pip install isbntools-2.2.2.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-2.2.2.tar.gz) the file!
