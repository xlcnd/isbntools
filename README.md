...
[![Build Status](https://travis-ci.org/xlcnd/isbntools.png?branch=v3.0.2)](https://travis-ci.org/xlcnd/isbntools)
...
```bash
    ...
    $ pip install isbntools-3.0.2.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-3.0.2.tar.gz) the file!
