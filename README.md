...
[![Coverage Status](https://coveralls.io/repos/github/xlcnd/isbntools/badge.svg?branch=v4.3.7)](https://coveralls.io/github/xlcnd/isbntools?branch=v4.3.7)
[![Build Status](https://travis-ci.org/xlcnd/isbntools.svg?branch=v4.3.7)](https://travis-ci.org/xlcnd/isbntools)
[![Build status](https://ci.appveyor.com/api/projects/status/github/xlcnd/isbntools?branch=v4.3.7&svg=true)](https://ci.appveyor.com/project/xlcnd/isbntools)
...
$ isbn_repl
    ...
    Welcome to the isbntools 4.3.7 REPL.
...
```bash
$ pip install isbntools-4.3.7.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-4.3.7.tar.gz) the file!
