...
[![Build Status](https://travis-ci.org/xlcnd/isbntools.png?branch=v2.0.9)](https://travis-ci.org/xlcnd/isbntools)
...
```bash
    ...
    $ pip install isbntools-2.0.9.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-2.0.9.tar.gz) the file!
