...
[![Build Status](https://travis-ci.org/xlcnd/isbntools.png?branch=v2.3.6)](https://travis-ci.org/xlcnd/isbntools)
...
```bash
    ...
    $ pip install isbntools-2.3.6.tar.gz
```
but first you have to [download](https://pypi.python.org/packages/source/i/isbntools/isbntools-2.3.6.tar.gz) the file!
...
[standalone version](https://sourceforge.net/projects/isbntools/files/isbntools-2.3.6-win.zip/download)
